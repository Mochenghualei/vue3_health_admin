...
const playList = [
  {
    playUrl: new URL("../assets/mp3/1-蔡依林邓紫棋-说爱你.mp3", import.meta.url).href,
    playTitle: "说爱你",
    player: "蔡依林/邓紫棋",
  ...
  {
    playUrl: new URL("../assets/mp3/4-华晨宇-孩子(Live).mp3", import.meta.url).href,
    playTitle: "孩子",
    player: "华晨宇",
    cover: new URL("../assets/cover/one.png", import.meta.url).href
  },
  {
    playUrl: new URL("../assets/mp3/3-蔡依林吴青峰-倒带.mp3", import.meta.url).href,
    playTitle: "倒带",
    player: "蔡依林/吴青峰",
    cover: new URL("../assets/cover/one.png", import.meta.url).href
  ...
  {
    playUrl: new URL("../assets/mp3/5-林俊杰 - 爱笑的眼睛.flac", import.meta.url).href,
    playTitle: "爱笑的眼睛",
    player: "林俊杰",
    cover: new URL("../assets/cover/one.png", import.meta.url).href
  }
