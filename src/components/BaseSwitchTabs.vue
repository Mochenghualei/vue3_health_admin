...
const HealthyAdmin = defineAsyncComponent(() => import('pages/Homepage/components/HomePageForHealth.vue'))
const ReadAdmin = defineAsyncComponent(() => import('pages/Homepage/components/HomePageForRead.vue'))
