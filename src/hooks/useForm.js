...
export function useForm() {
  ...
  const rules = {
    ...
    training: [{ required: true, validator: validateTrain, trigger: "change" }],
    sportTime: [{ required: true, validator: validateSportTime, trigger: "change" }],
    caloric: [{ required: true, validator: validateCaloric, trigger: 'change' }]
  }
  ...
  return {
    formRef, form, rules, trainingType, handleChange, onFinish, onFinishFailed, resetForm, locale
  }
}